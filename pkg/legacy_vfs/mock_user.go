...
func (m *MockUserManager) GetByUsername(username string) (*User, error) {
	m.ctrl.T.Helper()
...
func (mr *MockUserManagerMockRecorder) GetByUsername(username interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetByUsername", reflect.TypeOf((*MockUserManager)(nil).GetByUsername), username)
}
